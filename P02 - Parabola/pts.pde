...
class pts {
 ...
 int maxnv;                         //  max number of vertices
 pt[] G;                  // geometry table (vertices)
  pts(int maxnv) {G = new pt [maxnv]; this.maxnv = maxnv;}
  pts declare() {for (int i=0; i<maxnv; i++) G[i]=P(300, 300); return this;}               // init points
